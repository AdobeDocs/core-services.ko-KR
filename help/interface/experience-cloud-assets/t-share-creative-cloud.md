...
* 소셜 게시를 위해 [!UICONTROL 의 ]자산 선택기 [!DNL Adobe Social]에서 자산을 사용합니다. [발행자 페이지](https://marketing.adobe.com/resources/help/ko_KR/social/?f=c_pub_publisher)를 참조하십시오.
* 활동 이미지의 경우 [에서 ](컨텐츠 라이브러리)https://marketing.adobe.com/resources/help/ko_KR/target/target/?f=c_manage_content[!DNL Adobe Target]에 있는 자산을 로드 또는 교체하십시오.
