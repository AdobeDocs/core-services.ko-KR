...
설명서 아키텍처의 전체 개량. 추가됨 [Adobe Experience Cloud IP 주소](../data-collection/ip-addresses.md) 및 [지역 데이터 수집](../data-collection/rdc.md).
...
에 대한 설명서를 추가했습니다. [대상](../services/audiences/overview.md)
