...
문서 업데이트 목록은 [문서 업데이트](doc-updates.md)를 참조하세요.
...
| 일자 | 기능 | 설명 |
| -----------| -----------| ---------- |
| 2월 13일 | 스펙트럼 2 | 헤더 바 및 헤더 바에서 액세스한 구성 요소를 포함하는 Experience Cloud 응용 프로그램 프레임과 특정 응용 프로그램의 왼쪽 탐색 레일은 Adobe의 최신 디자인 시스템인 Spectrum 2로 업데이트됩니다. 이 새로 고침된 디자인에는 업데이트된 아이콘 표기가 포함되지만 동일한 기능이 있습니다. 그러나 헤더의 여러 요소는 다른 Adobe 사이트 및 애플리케이션과 일치하도록 재배치됩니다. |
...
| 기능 | 설명 |
| -----------| ---------- |
| 사용자 정의 가능한 홈 | Experience Cloud 랜딩 페이지에서 **[!UICONTROL Edit]**&#x200B;을(를) 클릭합니다. [!UICONTROL Edit] 모드를 사용하면 위젯 라이브러리 및 사용자 정의 배경에 액세스하여 Experience Cloud 홈 페이지를 개인 설정할 수 있습니다. [!UICONTROL Edit] 모드는 대량 작업 및 레이아웃 조정을 포함하여 위젯을 이동, 크기 조정 및 관리하기 위한 매끄럽고 직관적인 컨트롤을 제공하여 보다 심미적이고 맞춤형 경험을 제공합니다. |

## 2024년 9월 10일 수요일

| 기능 | 설명 |
| -----------| ---------- |
| Slack 알림 | Experience Cloud 알림이 Slack으로 전송되도록 계정 환경 설정을 구성할 수 있습니다. 자세한 내용은 [환경 설정](../features/account-preferences.md) 도움말에서 _Slack 알림_&#x200B;을 참조하세요. |
...
| 기능 | 설명 |
| ------- | ------- |
| 통합 홈 - 빠른 액세스 위젯 | **더 빠른 이동:** 이제 홈 환경을 더욱 개인화하고 원하는 애플리케이션을 결정할 수 있습니다. 새로운 고정 기능을 사용하여 [!UICONTROL Quick Access]의 앞과 가운데에 나타나는 응용 프로그램을 선택합니다. <br>**스마트 피닝으로 최신 정보 유지:** 이제 새 응용 프로그램을 더 쉽게 찾을 수 있습니다. 새로 할당된 응용 프로그램에는 _새로 만들기_ 배지가 표시되며 [!UICONTROL Quick Access]에 자동으로 고정됩니다. |
...
| 기능 | 설명 |
| ------- | -------|
| 검색 막대를 통해 Experience Platform 및 Journey Optimizer에서 [!UICONTROL Recents]에 액세스 | 이제 사용자는 통합된 검색창을 통해 AEP 및 AJO의 모든 페이지에서 최근에 액세스된 오브젝트에 액세스할 수 있습니다. |
...
| **[!UICONTROL Sandboxes]**&#x200B;이(가) 헤더 바로 이동됨 | 이제 샌드박스 표시기가 모든 Experience Platform 인터페이스 애플리케이션의 헤더에 통합되었습니다. 자세한 내용은 Experience Platform의 [샌드박스](https://experienceleague.adobe.com/docs/experience-platform/sandbox/ui/user-guide.html?lang=ko-KR)를 참조하십시오. |
...
* Experience Cloud [!UICONTROL Feed] 페이지는 사용되지 않습니다. (EXC-8505)
