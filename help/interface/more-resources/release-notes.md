...
| 일자 | 업데이트 | 설명 |
| -----------| -----------| ---------- |
| **2026년 1월 15일 금요일** | 사용자 정의 가능한 왼쪽 탐색 | 이제 Experience Cloud의 통합 쉘 왼쪽 탐색을 사용자 지정할 수 있습니다. 탐색 항목의 순서를 재지정하고 가장 중요한 기능에 빠르게 액세스할 수 있습니다. 이 업데이트는 워크플로우를 간소화하고 인지 부하를 줄이며 전체 키보드 접근성을 지원하여 효율성을 향상시킵니다. 애플리케이션 간에 일관되고 현대적인 디자인을 유지하고 향후 개인화를 가능하게 합니다. |
