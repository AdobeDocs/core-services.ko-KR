---
description: Adobe Experience Cloud, Adobe Analytics 및 Adobe Target 고객 속성에 대한 FAQ
keywords: Customer Attributes
solution: Adobe Experience Cloud
title: 고객 속성에 대한 FAQ | Adobe Experience Cloud
...
Adobe Analytics 및 Adobe Target의 고객 속성에 대한 FAQ와 모범 사례
...
| **(Adobe Target만 해당)** **[!UICONTROL 동기화 상태]** 열은 고객 특성 소스에 업로드된 파일에 대해 무엇을 나타냅니까? | 특정 특성 파일에 대한 동기화 상태 아이콘을 클릭하여 Adobe Target에 의해 게시되고 동기화된 레코드 수를 볼 수 있습니다. `Sync %`는 Adobe Target에서 동기화된 프로필의 비율(%)을 지정하는 실시간 지표입니다.<br> **참고:** 속성이 Adobe Target과 동기화되려면 최대 24시간이 걸릴 수 있습니다. |
