...
>[!IMPORTANT]
>
>이 문서의 내용은 법률적인 조언이 아니며, 법률적인 조언을 대체하지 않습니다. California Consumer Privacy Act에 대한 조언은 법률 자문관과 상의하십시오.

CPA(California Consumer Privacy Act)는 2020년 1월 1일에 발효되는 California의 새로운 개인 정보 보호법입니다. CPA는 캘리포니아 주민들에게 그들의 개인 정보에 대한 새로운 권리를 제공하고 캘리포니아에서 사업을 하는 특정 업체들에 데이터 보호 책임을 부과합니다. CPA는 소비자에게 개인 정보를 액세스하고 삭제할 수 있는 권한과 제3자에게 &quot;개인 정보 판매&quot;의 자격이 되는 특정 활동을 거부할 수 있는 권한을 제공합니다.
...
이 문서에서는 고객 속성이 Adobe Experience Platform 개인 정보 서비스 API 및 개인 정보 서비스 UI를 사용하여 데이터 주체의 CPA 데이터 액세스 및 삭제 권한을 지원하는 방법에 대해 설명합니다.
