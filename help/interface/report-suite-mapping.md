...
매핑할 보고서 세트에 액세스할 수 있는 로그인 회사의 Analytics 관리자여야 합니다. 또한 보고서 세트를 해당 조직에 매핑하려면 이 계정이 Experience Cloud 조직](organizations.md#topic_C31CB834F109465A82ED57FF0563B3F1)에 연결되어 있어야 합니다.[
...
이 알림은 보고서 세트 매핑에 대한 올바른 결정을 내리는 데 도움이 됩니다. 보고서 세트가 원래 다른 조직에 작성되었고 해당 조직이 이 보고서 세트에 대해 더 적합할 수 있는 경우 알리기 위한 것입니다.
