...
| **AMCV_###@AdobeOrg** | 34128000(395일) | | [`idMigrationEnabled`](https://experienceleague.adobe.com/ko/docs/experience-platform/web-sdk/commands/configure/idmigrationenabled)이(가) 활성화된 경우 표시됩니다. 사이트의 일부 부분이 여전히 `visitor.js`을(를) 사용하고 있는 동안 Web SDK으로 전환할 때 도움이 됩니다. |
