...
>[!NOTE]
>
>이 문서의 정보는 [Adobe Target JavaScript 라이브러리](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/targetglobalsettings.html){target=_blank}(`at.js`)에만 적용됩니다. 웹 SDK을 사용하는 Target 구현에 대한 정보는 [Adobe Experience Platform Web SDK 쿠키](web-sdk.md)를 참조하십시오.
>
