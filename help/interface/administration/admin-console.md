...
이 페이지에서는 CX 엔터프라이즈 관리자에게 특히 유용한 정보를 제공하고, 역할을 정의하며, Enterprise Guide의 일반 사용자 및 제품 관리 항목에 대한 링크를 제공합니다.
...
CX 엔터프라이즈 응용 프로그램의 ID 및 제품 라이선스를 관리하려면 [Admin Console](https://adminconsole.adobe.com/enterprise/)&#x200B;(으)로 이동하십시오.
...
| [디렉터리 트러스트를 통해 조직 설정](https://helpx.adobe.com/enterprise/using/directory-trust.html) | 다른 조직에서 이미 요청한 도메인에 대해 사용자를 인증합니다. 조직을 찾고 전환하는 방법에 대한 자세한 내용은 [CX Enterprise의 조직](organizations.md)을 참조하십시오. |
...
| [사용자 세부 정보 보기(관리 도구)](admin-tool-experience-cloud.md) | [!UICONTROL Admin Tool]에서 모든 CX 엔터프라이즈 사용자 및 정책을 세부 정보와 함께 정렬 및 필터링 가능한 목록으로 표시합니다. |
...
이 링크를 통해 특정 CX 엔터프라이즈 애플리케이션에 대한 관리 정보를 찾을 수 있습니다.
