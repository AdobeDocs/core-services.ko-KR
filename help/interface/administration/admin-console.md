...
| [디렉터리 트러스트를 통해 조직 설정](https://helpx.adobe.com/kr/enterprise/using/directory-trust.html) | 다른 조직에서 이미 요청한 도메인에 대해 사용자를 인증합니다. 조직을 찾고 전환하는 방법에 대한 자세한 내용은 [CX Enterprise의 조직](organizations.md)을 참조하십시오. |
