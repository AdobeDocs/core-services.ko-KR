...
| 도움말 링크 | 설명 |
| ------- | ------- |
| [Adobe ID 재설정](https://helpx.adobe.com/manage-account/kb/account-password-sign-help.html) | 로그아웃한 다음 **[!UICONTROL Get help signing in]** > **[!UICONTROL Reset your password]**&#x200B;을(를) 클릭합니다. |
