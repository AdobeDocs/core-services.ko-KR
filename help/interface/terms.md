...
| 컨텍스트 | 일반적으로 수행되는 선택 또는 작업에 따라 사용할 수 있는 메뉴 또는 정보를 나타냅니다. | 컨텍스트는 디지털 속성에 대한 방문자의 현재 상호 작용에 대한 세부 사항을 설명합니다. 컨텍스트의 예에는 마우스 위치, 양식 필드의 상태, 장바구니의 값 또는 사용하고 있는 장치가 포함됩니다.<br>[다이내믹 태그 관리는](https://docs.adobe.com/content/help/ko-KR/dtm/using/dtm-home.html) 현재 시장에서 가장 강력한 컨텍스트 탐지 및 서비스 활성화 기능을 제공하고 프로필 및 대상 서비스의 컨텍스트 구성 요소를 제공합니다. |
