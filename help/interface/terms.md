...
Experience Cloud 사용자를 위한 용어 참조와 해당 용어가 Creative Cloud에서 어떻게 사용되는지(해당되는 경우).
...
| 장치 | 특별한 용도는 없습니다. | 태블릿, 휴대폰 또는 데스크탑과 같은 하드웨어 장치로서 응용 프로그램이 실행됩니다. |
| Device Co-op | 특별한 용도는 없습니다. | 소비자가 사용하는 디바이스에 대한 데이터를 공유하여 모든 디바이스에 걸쳐 개인화된 경험을 보다 효과적으로 전달하고 의미 있고 일관된 경험을 제공하기로 동의한 브랜드 그룹 |
| [!UICONTROL Experience Cloud ID 서비스] (ECID) | 특별한 용도는 없습니다. | 사이트 방문자에게 할당된 고유한 영구 ID입니다. Experience Platform ID 서비스에서 사용할 수 있는 특정 엔터티입니다. [자세히...](https://docs.adobe.com/content/help/en/id-service/using/home.html) |
...
| 지표 | 일반적으로 Creative Cloud에서는 사용되지 않습니다. | 주요 개념 및 목표에 대한 숫자들을 집계합니다.  Analytics에서 지표는 보기 수, 클릭스루 횟수, 다시 로드 횟수, 평균 체류 시간, 판매량, 주문 수, 매출액 등과 같은 방문자 활동에 대한 수량 정보입니다.  [지표 설명](https://docs.adobe.com/content/help/en/analytics/components/variables/metrics/metricslist.html)을 참조하십시오. |
...
| 세그먼트 | N/A | 대상을 평가할 규칙 세트의 출력입니다. Analytics에서 [세그먼트를](https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html) 사용하여 Experience Cloud로 전달할 수 있는 대상을 정의할 수도 있습니다. <br>Audience Manager에서 세그먼트는 [트레이트](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/traits/traits-overview.html) 및 방문자의 멤버십 자격 또는 해당 세그먼트에 포함할 수 있는 모든 기준의 컬렉션입니다. 또한, 이것은 이러한 공통적인 속성을 공유하는 사람들의 집합입니다. |
