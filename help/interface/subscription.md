---
description: 솔루션 데이터 소스 및 구독 구성에 대해 알아봅니다. 가입을 통해 Experience Cloud과 애플리케이션(Analytics 및 Target) 간에 고객 속성 데이터 흐름을 사용할 수 있습니다.
...
애플리케이션 데이터 소스 및 가입 구성에 대해 알아봅니다. 가입을 통해 Experience Cloud과 애플리케이션 간에 고객 속성 데이터 흐름을 사용할 수 있습니다([!DNL Analytics] 및 [!DNL Target]).
