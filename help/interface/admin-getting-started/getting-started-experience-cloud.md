...
| 요소 | 설명 |
|--- |--- |
| [Admin Console 기본 사항](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) | Experience Cloud 솔루션을 사용하기 위해 수행해야 하는 초기 절차에 대해 알아봅니다. |
...
| [Creative Cloud 사용자 관리](../experience-cloud-assets/t-admin-add-cc-user.md) | Experience Cloud 자산을 사용하면 마케터가 Creative Cloud을 사용하여 디자이너 및 다른 창의적인 자산과 폴더를 공유, 동기화 및 공동 작업할 수 있습니다. 여기서 조직과 공동 작업하도록 승인된 Creative Cloud 사용자를 관리할 수 있습니다. |
...
| destURL | 사용자가 이동해야 하는 위치의 전체 URL입니다. | https://sc.omniture.com/login?r=%2Fx%2F1_7xxzf&amp;tenantId=obuengsc&amp;company=OBU+Eng+SC | 선택 사항입니다 |
