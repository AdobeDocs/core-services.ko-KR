...
>[!IMPORTANT]
>
>관리자, [사용자](../admin-getting-started/admin-getting-started.md#topic_3FCB4099640647E3B2411ADBFCE81909) 및 제품 관리에 대한 업데이트에 대한 자세한 내용은 관리를 참조하십시오.

## Experience Cloud에 로그인(관리자) {#task_034FC955031347F3B02B686A09801A08}

로그인하여 [올바른 조직에](../admin-getting-started/organizations.md#topic_C31CB834F109465A82ED57FF0563B3F1)소속되어 있는지 확인하십시오.

1. Experience Cloud 풀다운 메뉴 ( ![](assets/menu-icon.png)) 를 클릭한 다음 **[!UICONTROL 관리를 클릭합니다]**.
...
1. Adobe ID로 **[!UICONTROL 로그인을]** 클릭합니다.

   Experience Cloud 관리자가 계정 유형(Adobe ID 또는 Enterprise ID)을 확인하는 데 도움을 줄 수 있습니다.

1. 피드 페이지 (또는 기본 랜딩 페이지) 에서 선택기 아이콘을 ![](assets/menu-icon.png) 클릭하여 풀다운 메뉴를 액세스합니다.

   ![](assets/experience-cloud-core-services.png)

   이 메뉴에 표시되는 솔루션 및 서비스는 [관리자가 정의한 응용 프로그램 권한에 따라](../admin-getting-started/admin-getting-started.md#topic_3FCB4099640647E3B2411ADBFCE81909)달라집니다.
...
1. 프로필 **[!UICONTROL 편집을]** 클릭합니다.

   ![](assets/default-organization.png)
1. 개인 정보를 계속 구성하고 편집한 다음 변경 내용 **[!UICONTROL 저장을 클릭합니다]**.
...
알림으로 이동하려면 **[!UICONTROL 알림]** 아이콘을 ![](assets/notifications-icon.png)클릭한 다음 **[!UICONTROL 설정]** 아이콘을 ![](assets/icon_edit_board.png)클릭합니다.
...
>[!NOTE]
>
>매개 변수에 전달하기 전에 URL `destURL` 를 인코딩해야 합니다. (URL 디코더/인코더 같은 [인코더 사이트를 사용할](https://meyerweb.com/eric/tools/dencoder/) 수 있습니다.)
