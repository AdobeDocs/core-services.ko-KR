...
>[!IMPORTANT]
>
>Admin Console의 사용자를 관리하면 새로운 용어, 인터페이스 및 내비게이션이 도입됩니다. 다음 정보는 이러한 변경 사항에 대해 설명하고 추가 도움말 자료에 대한 링크를 제공합니다. 이 도움말은 [Enterprise Administration 사용 안내서](https://helpx.adobe.com/enterprise/managing/user-guide.html)에 있는 모든 Adobe 클라우드 제품에 대한 정보를 보완합니다.
...
또는 Experience Cloud 메뉴 ( ![](assets/menu-icon.png)) 에서 **[!UICONTROL 관리]** &gt; 관리 콘솔 **[!UICONTROL 실행을 클릭합니다]**.

**관련 도움말**

Creative Cloud 및 Document Cloud에 대한 [관리 사용 안내서](https://helpx.adobe.com/enterprise/using/users.html). 일부 정보는 [ID 유형 관리](https://helpx.adobe.com/enterprise/help/identity.html)와 같은 Experience Cloud 사용자 관리와 관련이 있습니다.
...
계정 마이그레이션이 단계적으로 고객에게 배포되고 있습니다. Adobe는 기존 사용자 계정을 **[!UICONTROL 관리 도구]** &gt; **[!UICONTROL 사용자 관리에서]** 관리 콘솔로 마이그레이션하는 시점이 귀하의 시간이면 알려드립니다.
...
## Target - 제품 프로필과 작업 영역 비교 {#section_3860AF177C9E4C7E9C390D36A414F353}
...
보안 [그룹에 대한 자세한 내용은 그룹 및 사용자](https://helpx.adobe.com/campaign/standard/administration/using/managing-groups-and-users.html) 관리 및 보안 그룹에 사용자 지정을 참조하십시오.

## Experience Platform Launch {#section_F2DA6778DD2D48AA8F794041971EE6B1}

Launch, Adobe 제공은 Admin Console에서 제품 페이지에 표시됩니다. Launch 제품 프로필에 다른 솔루션 및 핵심 서비스를 포함할 수 있습니다.

관리 콘솔에서 사용자 권한에 대한 자세한 내용은 [사용자 관리를](https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/user-management.html) 참조하고 프로파일에 대한 권한 할당을 포함하여 론치 전용 옵션을 설정합니다.

## 다이내믹 태그 관리자 {#section_3A41CF2BD5994B9891537D063571D4ED}

사용자를 다이내믹 태그 관리에 초대하고, 사용자 역할을 지정하고, 사용자를 그룹에 추가합니다.

다이내믹 태그 관리에 사용자를 초대하고 사용자 역할을 할당하고 그룹에 사용자를 추가하는 방법에 대한 자세한 [내용은 사용자 및 권한을](https://marketing.adobe.com/resources/help/en_US/dtm/users.html) 참조하십시오.

## Audience Manager {#section_C31E3FA8A1E14463B1B3E07235F1983C}

Audience Manager 사용자를 만들고 그룹에 지정합니다. 제한(트레이트, 세그먼트, 대상 및 AlgoModel)을 볼 수도 있습니다.

Audience Manager 도움말의 [관리를](https://marketing.adobe.com/resources/help/en_US/aam/c_administration.html) 참조하십시오.
...
1. [Admin Console](https://adminconsole.adobe.com/enterprise/)에서 **[!UICONTROL 제품을]** 클릭합니다.
1. 새 프로필을 **[!UICONTROL ]** 클릭합니다.
1. 프로필 세부 사항을 구성하고 **[!UICONTROL 다음을 클릭합니다]**.
...
1. 제품 프로필에서 **[!UICONTROL 권한]** (관리자만 사용 가능) 를 클릭합니다.
1. 프로필의 권한 구성:
...
1. 관리 콘솔에서 **[!UICONTROL 사용자를]** 클릭한 다음 사용자 이름을 클릭합니다.
1. 관리자 권한 **[!UICONTROL 편집을]** 클릭합니다.
1.  사용자의 관리 권한을 구성합니다. 
1. 다음을 클릭하여 **[!UICONTROL 설정을]** 검토하고 **[!UICONTROL 저장을 클릭합니다]**.
