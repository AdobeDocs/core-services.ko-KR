...
>[!IMPORTANT]
>
>Admin Console에서 사용자 관리는 새 용어, 인터페이스 및 탐색을 소개합니다. 다음 정보는 이러한 변경 사항에 대해 설명하고 추가 도움말 자료에 대한 링크를 제공합니다. 이 도움말은 [Enterprise Administration 사용 안내서](https://helpx.adobe.com/enterprise/managing/user-guide.html)에 있는 모든 Adobe 클라우드 제품에 대한 정보를 보완합니다.
