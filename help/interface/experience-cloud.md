---
description: CX Enterprise(이전 Experience Cloud)의 중앙 인터페이스 구성 요소에 대해 알아봅니다. 사용자 및 제품 관리에 대한 도움말을 확인하고 공유 인터페이스 서비스를 위한 애플리케이션을 사용하도록 설정합니다. 대상 라이브러리, 고객 속성, Assets 등에 대한 도움말을 봅니다.
title: CX Enterprise 인터페이스 및 관리 안내서
...
[CX Enterprise](https://experience.adobe.com)&#x200B;(이전의 _Experience Cloud_)은(는) Adobe의 디지털 마케팅 애플리케이션, 제품 및 서비스 통합 제품군입니다. 직관적인 인터페이스에서 클라우드 애플리케이션, 제품 기능 및 서비스에 빠르게 액세스할 수 있습니다.
