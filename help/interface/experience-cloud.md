...
1. 올바른 조직에 속해 있는지 확인합니다.
   ...
   **참고:** 조직의 관리자가 IP 주소별로 Adobe 제품에 대한 액세스를 제한할 수 있습니다. 이 경우 Experience Cloud에 로그인하거나 이 기능이 활성화된 조직으로 전환하면 오류가 발생할 수 있습니다. 자세한 내용은 [IP 주소로 제품 액세스 제한](https://helpx.adobe.com/kr/enterprise/using/ip-based-access.html)을 참조하세요.
