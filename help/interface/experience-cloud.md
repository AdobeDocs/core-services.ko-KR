...
| [!UICONTROL 맞춤형 학습 권장 사항 및 프로모션] | Adobe 제품에 대한 개인화된 지원을 받을 위치를 선택하십시오. 해당 지원은 이메일, 제품 내 알림 및 Experience League 커뮤니티를 통해 제공됩니다. [자세히 알아보기](features/personalized-learning.md) |
