...
조직 내에서 프로비저닝된 Experience Cloud 응용 프로그램 및 서비스에 액세스하려면 애플리케이션 선택기 ![](assets/menu-icon.png)으로 이동하십시오.
...
>[!NOTE]
>
>전역 검색은 일부 Experience Cloud 응용 프로그램에서 사용할 수 없지만, 더 많은 콘텐츠가 색인화되면 관련 응용 프로그램에 추가됩니다. 2021년 7월 출시:
...
Experience Cloud은 다음 호스트를 사용하여 애플리케이션을 전달하고 성능과 제품 경험을 개선합니다. Adobe은 최적의 환경을 위해 이러한 도메인을 방화벽의 허용 목록에 추가하는 것이 좋습니다. Adobe Analytics과 같은 특정 Experience Cloud 애플리케이션에도 추가 도메인을 사용할 수도 있습니다. 자세한 내용은 해당 애플리케이션에 대한 설명서를 확인하십시오.

| 기술 | 도메인 |
|--- |--- |
| Adobe Experience Cloud 도메인 | `adobe.com`, `adobe.net`, `adobe.io` |
| IMS(Identity Management Service) Adobe | `adobelogin.com` |
| Experience Cloud 글꼴 | `typekit.net` |
| Gainsight(제품 지침 및 도움말) | `esp.aptrinsic.com` |
