...
지침이 필요하면 [Adobe Experience Cloud - Adobe 옵트 아웃 구현](https://experienceleague.adobe.com/docs/analytics/implementation/javascript-implementation/data-collection/opt-out.html?lang=en)을 참조하십시오.
