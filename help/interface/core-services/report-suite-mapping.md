...
1. **[!UICONTROL Experience Cloud]&gt;****[!UICONTROL 관리]&gt;****[!UICONTROL 보고서 세트 매핑]** 을 클릭합니다.
   ...
   또한 [직접 URL](https://audience.marketing.adobe.com/rsmapping/ui.html)을 사용할 수 있습니다.
...
Experience Cloud ID 서비스가 현재 보고서 세트에 배포된 경우 보고서 세트 매핑 도구에서 선택한 조직이 사이트의 [!DNL visitorAPI.js] 파일에 지정된 동일한 조직인지 확인하십시오. [Experience Cloud ID 서비스 테스트 및 확인](https://marketing.adobe.com/resources/help/ko_KR/mcvid/mcvid-test-verify.html)의 지침을 사용하여 방문자 ID 서비스에서 사용 중인 조직 ID를 찾을 수 있습니다.
...
[조직 및 계정 설정](https://marketing.adobe.com/resources/help/ko_KR/mcloud/?f=organizations)에서 조직 이름을 찾을 수 있습니다.
