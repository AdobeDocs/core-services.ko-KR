...
1. 페이지에서 Experience Cloud 응용 프로그램을 활성화하는 코드를 삽입하려면 [Experience Platform Launch](https://experienceleague.adobe.com/docs/launch/using/home.html?lang=en)을 사용하십시오.
