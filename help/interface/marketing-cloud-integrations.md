...
Adobe Experience Cloud는 강력한 기능들로 구성된 공통 세트를 사용하여 공통 데이터 플랫폼에 구축된 포괄적인 최고급 통합 솔루션 세트입니다.
...
* 관리자가 될 수 있도록 설정.
* [Experience Cloud ID 서비스 구현](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.html).
* DTM을 통해 [!DNL Analytics] 및 [!DNL Target] 구현 현대화.
* 핵심 서비스 사용 시작.
...
[Experience Cloud ID 서비스](https://docs.adobe.com/content/help/en/id-service/using/home.html)를 참조하십시오

**해당 솔루션 또는 서비스**

* [Adobe Analytics](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.htmlmcvid-setup-analytics.html)
* [Adobe Target](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.htmlmcvid-setup-target.html)
* [[!UICONTROL Data Workbench]](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.htmlmcvid-dwb.html)
...
>[!NOTE]
>
>고객 속성은 이전 핵심 서비스로서 현재 유지 관리 하에 있습니다.
...
도움말: [Creative Cloud와 Experience Cloud 폴더 공유](https://docs.adobe.com/content/help/ko-KR/core-services/interface/assets/creative-cloud.html)
...
도움말: [Analytics의 AEM Assets 보고](https://docs.adobe.com/content/help/ko-KR/analytics/integration/aem-assets-reporting.html)
...
[Audience Manager](https://docs.adobe.com/content/help/ko-KR/audience-manager/user-guide/implementation-integration-guides/implementation-and-integration.html)
...
* [Audience Manager 세그먼트를 Analytics에 보내기](https://docs.adobe.com/content/help/ko-KR/audience-manager/user-guide/features/destinations/experience-cloud-destinations/create-analytics-destination.html)
* [Adobe Target 데이터 통합](https://docs.adobe.com/content/help/ko-KR/audience-manager/user-guide/implementation-integration-guides/integration-other-solutions/aam-target-integration.html)
...
1. [Experience Platform Launch](https://docs.adobe.com/content/help/ko/launch/using/overview.html) 또는 [Dynamic Tag Management](https://docs.adobe.com/content/help/ko/dtm/using/dtm-home.html)를 사용하여 페이지에서 [Adobe Experience Cloud 솔루션](solutions-core-services.md#topic_BD726D3A649E4FC49063029E86B70C62)을 활성화하는 코드를 삽입합니다.
...
* [Analytics](https://docs.adobe.com/content/help/ko-KR/analytics/analyze/analysis-workspace/home.html)
* [Audience Manager](https://docs.adobe.com/content/help/ko-KR/dtm/using/tools/audiencemgmt.html)
* [Media Optimizer](https://docs.adobe.com/content/help/ko-KR/dtm/using/tools/media-optimizer.html)
* [Adobe Target](https://docs.adobe.com/content/help/ko-KR/dtm/using/tools/target.html)
* [MAC ID 서비스](https://docs.adobe.com/content/help/ko-KR/dtm/using/tools/macid.html)
* [Nielsen 추적](https://docs.adobe.com/content/help/ko-KR/dtm/using/tools/nielsen.html)
...
* 고객 속성: 고객 속성에 대한 Adobe Target의 [가입](https://docs.adobe.com/content/help/en/core-services/interface/customer-attributes/subscription.html) 구성
...
* Campaign: [Adobe Target과 Campaign 통합](https://docs.adobe.com/content/help/ko-KR/target/using/integrate/campaign-and-target.html)
...
* [분석](https://docs.adobe.com/docs/kr/aem/6-2/administer/integration/marketing-cloud/sitecatalyst.html)
...
* [타사 서비스](https://docs.adobe.com/docs/en/aem/6-2/administer/integration/third-party-services.html)(data connectors)
...
도움말: [Experience Cloud 및 Creative Cloud로 AEM Assets 통합 구성](https://docs.adobe.com/docs/en/aem/6-2/administer/integration/configure-assets-cc-integration.html)
...
**Analytics**&#x200B;는 사이트 참여 및 변환 데이터를 매일 Media Optimizer로 전송할 수 있습니다. 여기서 광고 최적화 및 보고를 위해 데이터를 사용할 수 있습니다. 또한 Media Optimizer는 검색 엔진 및 소셜 네트워크 트래픽 데이터를 매일 Analytics로 전송할 수 있습니다. 여기서 Reports and Analytics, Report Builder 및 Ad Hoc Analysis 기능에 이러한 데이터를 사용할 수 있습니다.

**다이내믹 태그 관리자:** 검색, 소셜 및 디스플레이 광고 랜딩 페이지용으로 [다이내믹 태그 관리자를 사용하여 Media Optimizer 픽셀 기반 변환 추적 태그](https://docs.adobe.com/content/help/en/dtm/using/tools/media-optimizer.html)와 타사 추적 태그를 만들 수 있습니다. (Media Optimizer 내에서 직접 Media Optimizer 태그를 만들 수도 있습니다.)

**Experience Cloud 대상:** (디스플레이 관리 부서가 있는 광고주) [Adobe Experience Cloud 대상](https://docs.adobe.com/content/help/en/core-services/interface/audiences/audience-library.html)을 디스플레이 광고 대상으로 사용할 수 있습니다. Adobe Experience Cloud에서 만든 대상과 Adobe Experience Cloud에 게시한 분석의 대상을 자동으로 사용할 수 있으며, Media Optimizer 계정이 Audience Manager의 대상 사용을 허용하도록 구성된 경우 이 대상도 사용할 수 있습니다. Adobe Experience Cloud, 프로필 및 대상에 대한 액세스와 Media Optimizer 및 Adobe Experience Cloud 대상 간 초기 설정에 대한 자세한 내용은 계정 관리자에게 문의하십시오. **참고:** Adobe Target도 사용하는 경우 Adobe Experience Cloud에 게시한 모든 대상을 Adobe Target의 활동에도 사용할 수 있습니다.
...
**Experience Cloud 알림:** 각 페이지 맨 위에 있는 알림 링크에서 검색 베타 경고 템플릿과 Adobe Experience Cloud 시스템 업데이트, 게시물, 언급 및 공유 자산에서 생성된 모든 경고를 볼 수 있습니다. 알림에 액세스하려면 [Adobe Experience Cloud를 통해 Media Optimizer에 로그인](https://enterprise-test.efrontier.com/CMDashboard/help/internal/getting_started/t_log_in_from_adobe_marketing_cloud.htm)해야 합니다. Adobe Experience Cloud 액세스에 대한 자세한 내용은 계정 관리자에게 문의하십시오.
