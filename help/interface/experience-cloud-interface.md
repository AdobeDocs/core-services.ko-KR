...
### Experience Cloud [!UICONTROL Preferences] 관리
...
[!UICONTROL Experience Cloud preferences]에서 다음 기능을 구성할 수 있습니다.

| 기능 | 설명 |
|--- |--- |
| 기본 조직 | Experience Cloud를 시작할 때 보려는 조직을 선택합니다. |
