...
1. **[!UICONTROL Sign in with an Adobe ID]**&#x200B;을(를) 클릭합니다.
...
CX Enterprise 검색을 사용하면 [Experience League](https://experienceleague.adobe.com/#home)에서 도움말(설명서, 튜토리얼 및 과정)을 검색할 수 있습니다.
...
본인에게 중요한 알림과 Adobe의 공지를 보려면 **[!UICONTROL Notifications]**&#x200B;을(를) 클릭하십시오.
