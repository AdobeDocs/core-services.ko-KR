...
1. `https://experience.adobe.com/.`에 로그인합니다.
   ...
   ![Admin Console 액세스](assets/admin-tool.png)

1. [!UICONTROL 빠른 액세스] 아래에서 **[!UICONTROL 관리 도구]**&#x200B;를 선택합니다.
...
이 페이지에는 조직에서 Experience Cloud에 액세스할 수 있는 전체 사용자 목록이 표시됩니다. 애플리케이션 자격 및 마지막 로그인에 대한 정보를 제공합니다. 사용자 목록을 검색, 정렬 및 필터링하여 요구에 맞게 표시할 수 있습니다.
...
| [!UICONTROL 솔루션] | 사용자가 액세스할 수 있는 Experience Cloud 응용 프로그램의 요약 필터를 적용하여 특정 애플리케이션 액세스 권한이 있는 사용자 목록의 범위를 좁힐 수 있습니다. |
...
| [!UICONTROL 솔루션] 필터 | 사용 가능한 응용 프로그램 중에서 선택합니다. 여러 애플리케이션 필터가 솔루션 1이 포함된 결과를 검색합니다 `OR` 솔루션 2. |

## 사용자 세부 사항 보기

[!UICONTROL 사용자] 페이지에서 사용자의 세부 사항을 보려면 사용자 이메일을 선택하십시오.

![Admin Console에서 사용자 세부 사항 보기](assets/admin-tool-user-details.png)
...
이 섹션에는 사용자가 액세스할 수 있는 Experience Cloud 응용 프로그램의 요약이 표시됩니다. 해당되는 경우 제품 관리 역할을 포함합니다.
...
![Admin Console에서 정책 세부 사항 보기](assets/admin-tool-policy-detail.png)
