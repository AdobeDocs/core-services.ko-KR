...
핵심 서비스에 대한 구현이 제공되지 않은 경우, 다음을 참조하십시오 [핵심 서비스용 애플리케이션 활성화](core-services.md#concept_07ED1D5C64234E77976E6D572E78FB9C)는 다음 방법을 설명합니다.
...
Experience Cloud 인터페이스에서 제공하는 기능은 귀하의 비즈니스에 새로운 가치를 가져옵니다. 앞으로 애플리케이션 액세스를 위한 표준 경로로, 결과적으로 다른 개별 애플리케이션 로그인 흐름을 대체합니다. Experience Cloud를 통해 로그인하면 나중에 원활하게 전환할 수 있습니다.
...
* 사용자는에 로그인하기 시작할 수 있습니다 [!DNL Experience Cloud] 애플리케이션 연결
* 또한 Experience Cloud를 통해 사용자와 같은 기능을 사용할 수 있습니다.
* 애플리케이션별 로그인 프로세스의 사용을 중단할 준비를 갖출 수 있습니다.
* 응용 프로그램에 대한 액세스 제어 권한은 그대로 유지할 수 있습니다.
...
자세한 내용은 [Adobe ID에 애플리케이션 계정 연결](organizations.md#task_FD389E78640848919E247AC5E95B8369).
...
아니요. 사용자는 자신의 응용 프로그램을 사용자 이름 및 암호에 연결해야 합니다.

## 우리 회사에 Social이 없는데 내게 보이는 이유는 무엇입니까?

Adobe Social은 Analytics와 함께 판매할 수 있는 제품입니다. 따라서 Analytics가 있으면 이 애플리케이션이 표시되지만 구매하지 않은 경우에는 액세스할 수 없습니다.
