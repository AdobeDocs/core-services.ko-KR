...
| Audience 에이전트 | 지식 기반 대상/계정 생성 | <ul><li>Real-Time CDP (B2B, B2C 및 B2P 에디션)</li><li>Adobe Journey Optimizer(B2C Edition)</li></ul> | 150 | <ul><li><em>캘리포니아에 거주하는 사람들로 구성된 대상자를 만듭니다</em></li><li><em>이번 분기에 1,000달러 이상 지출한 VIP 회원의 대상자 생성</em></li><li><em>의류 항목을 구입했지만 지난 60일 동안 구입하지 않은 사용자를 대상으로 대상 만들기</em></li></ul> |
...
| Journey Agent | 여정 생성 | <ul><li>Adobe Journey Optimizer (B2B 및 B2C 에디션)</li></ul> | 30 | <ul><li><em>지난 7일 동안 첫 구매를 완료하지 않은 사용자에게 미리 알림을 보낼 여정을 생성합니다.</em></li><li><em>사용자가 첫 구매를 완료하면 3일 후 이메일로 SMS 확인 및 후속 혜택 설명을 보내세요</em></li></ul> |
...
| 제품 지원 에이전트 | 지원 사례 만들기 및 추적 | <ul><li>Real-Time CDP (B2B, B2C 및 B2P 에디션)</li>Adobe Journey Optimizer (B2C 및 B2B 에디션)<li>Customer Journey Analytics (B2C 및 B2B 에디션)</li><li>Adobe Experience Manager</li></ul> | 10 | <ul><li><em>실패한 세분화 작업에 대한 새 지원 티켓 만들기</em></li><li><em>티켓 전자 메일의 001772068이 무엇입니까?</em></li></ul> |
...
| 브랜드 경험 에이전트 | <ul><li>콘텐츠 업데이트</li><li>Forms 제작</li><li>파이프라인 문제 해결</li></ul> | <ul><li>Adobe Experience Manager 클라우드 서비스</li><li>Adobe Experience Manager Sites</li><li>Adobe Experience Manager Forms</li></ul> | 50 | <ul><li><em>이름, 전자 메일 및 메시지 필드가 있는 연락처 양식을 만듭니다</em></li><li><em>실패한 파이프라인 문제 해결</em></li><li><em>주 프로그램에 대해 실패한 파이프라인을 나열합니다.</em></li></ul> |
