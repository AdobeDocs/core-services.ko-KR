...
AI가 수동 입력에 의존하는 대신 설명 태그를 디지털 에셋에 자동으로 할당할 수 있다. 이러한 AI 생성 태그는 메타데이터 품질을 향상시켜 에셋을 보다 쉽게 검색, 분류 및 추천할 수 있도록 합니다. [자세히 알아보기](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/assets/manage/smart-tags#ai-smart-tags)
