...
description: 생성 AI(GenAI)와 Experience Cloud 애플리케이션에서 GenAI 및  [!DNL AI Assistant]을(를) 사용하는 방법에 대해 알아봅니다.
...
[!DNL AI Assistant]은(는) Experience Platform 및 관련 응용 프로그램에서 지원되는 대화 도구입니다. 지원되는 제품에서 _제품 지식_ 및 _운영 통찰력_&#x200B;을 빠르게 얻을 수 있습니다.
...
다음 Experience Cloud 애플리케이션은 생성 AI 또는 [!DNL AI Assistant]을(를) 지원합니다. Adobe Firefly에 대한 지원도 제품별로 표시됩니다.
...
Customer Journey Analytics을 사용하면 다음과 같은 방법으로 생성 AI를 사용할 수 있습니다.

* 제품 지식의 [!DNL AI Assistant]
* AI Assistant의 [!DNL Product Support Agent]
...
Marketo(premium)에서는 대화형 웨비나 및 Dynamic Chat에서 생성 AI를 사용할 수 있습니다.
