...
* [!DNL Customer Journey Analytics]의 AI Assistant에서 액세스할 수 있는 **Data Insights Agent:** [Data Insights Agent](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)은(는) 데이터에 대한 질문에 빠르고 효율적으로 답변할 수 있는 생성 AI 대화 에이전트입니다. 데이터 보기의 구성 요소를 사용하고 실제 데이터를 사용하여 [!UICONTROL Analysis Workspace]에서 관련 시각화를 만듭니다.
...
* 제품 지식을 위한 [AI 길잡이](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant)
* AI Assistant의 [제품 지원 에이전트](https://experienceleague.adobe.com/ko/docs/experience-platform/ai-assistant/new-features/customer-support)
* AI Assistant의 [Data Insights Agent](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)
* Workspace 시각화의 [지능형 캡션](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions)
* 모든 에셋 메타데이터를 자동으로 할당하려면 [Content Analytics](https://experienceleague.adobe.com/ko/docs/analytics-platform/using/content-analytics/report/report#template)
