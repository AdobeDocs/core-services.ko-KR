...
| [!UICONTROL 제품 사용 데이터] | Experience Cloud 애플리케이션을 사용할 때 Adobe과 공유되는 제품 사용 데이터를 제어할 수 있습니다. 이는 조직의 콘텐츠나 데이터 자체가 아니라 당사 제품을 사용하는 방식에 대한 데이터입니다. Adobe은 이 정보를 사용하여 당사의 제품을 개선하고, 향상된 제품 내 지원을 제공하며, 당사의 경험과 커뮤니케이션을 개인화합니다. <p>자세한 내용은 [제품 사용 데이터](#product-usage-data)(이 페이지)를 참조하세요. |
...
* [!DNL Slack] 계정이 있어야 합니다. [!DNL Slack] 관리자가 [!DNL Slack]과(와) Experience Cloud 통합을 사용하도록 설정합니다.
...
[!DNL Slack]이(가) 설치되지 않은 경우 _[!UICONTROL Slack에 추가]_&#x200B;를 클릭한 후 Slack이 열리면 **[!UICONTROL 설치 요청]** 메시지가 표시됩니다. 예:
...
1. [!DNL Slack] 승인을 받은 후 Experience Cloud **[!UICONTROL 알림]**(으)로 돌아가서 [Slack에 구독](#slack-notifications)(위에서 설명)하는 단계를 따릅니다.
...
* Experience Cloud에서 모든 알림을 볼 수 있는 링크입니다.
* Experience Cloud에서 알림 환경 설정을 관리할 수 있는 링크입니다.
