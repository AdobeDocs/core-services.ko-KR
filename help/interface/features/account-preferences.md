...
Experience Cloud 환경 설정을 찾으려면 헤더에서 **[!UICONTROL Profile]** ![환경 설정](../assets/preferences-icon-sm.png)을 클릭한 다음 **[!UICONTROL Preferences]**&#x200B;을(를) 클릭합니다.
...
1. [!DNL Slack] 승인을 받은 후 Experience Cloud **[!UICONTROL Notifications]**(으)로 돌아가서 [Slack에 가입](#slack-notifications)(위에서 설명)하는 단계를 따릅니다.
...
## Experience Cloud에서 [!UICONTROL notifications] 및 공지 보기
