...
* **AI 우선 Experience Cloud 앱:** 이러한 앱은 AI를 핵심으로 합니다. 이들은 주요 작업에 생성 또는 아젠틱 AI를 사용하며, 아젠틱 기능은 Agent Orchestrator 추가 기능 없이도 이미 애플리케이션 라이선스에 포함되어 있습니다.

  AI 기반 앱은 <b>*</b>(으)로 표시되어 있습니다.

## 가용성 및 지원되는 애플리케이션

AI 에이전트 및 지원되는 애플리케이션의 가용성에 대해 알아봅니다.
...
| [실험 에이전트](https://experienceleague.adobe.com/ko/docs/journey-optimizer/using/content-management/content-experiment/experiment/experiment-accelerator-security)<b>*</b> | 사용 가능 | <ul><li>AJO Experimentation Accelerator</li></ul> | 분석을 자동화하여 실험 및 성장 기회를 식별합니다. |
