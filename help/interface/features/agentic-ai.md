...
description: CX Enterprise 애플리케이션에서 Agentic AI를 사용할 수 있는 위치를 알아봅니다.
...
# Adobe CX Enterprise의 아젠틱 AI

업데이트 날짜: **2026년 4월 6일**

Adobe Experience Platform 에이전트는 [Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/ko/docs/experience-cloud-ai/experience-cloud-ai/home)에서 제공하는 기능을 통해 CX Enterprise 애플리케이션에서 에이전트 AI 기능을 활성화합니다.

이러한 에이전트는 작업을 자동화하고 통찰력을 신속하게 제공하며 워크플로를 간소화하는 데 도움이 됩니다. 따라서 팀이 보다 효율적으로 작업하고 CX Enterprise에서 더 많은 가치를 얻을 수 있습니다.

CX Enterprise의 AI 에이전트에 대한 액세스 권한은 다음 중 하나에서 제공됩니다.

* [기존 CX Enterprise 애플리케이션](#existing-apps)
* [AI 우선 CX Enterprise 애플리케이션](#ai-first-apps)

다음 섹션에서는 CX Enterprise에서 아젠틱 AI를 활성화하는 두 가지 방법에 대해 설명합니다.
...
에이전트는 다음 범주 중 하나에 있는 고객을 위한 기존 CX Enterprise 앱에서 활성화할 수 있습니다.
...
AI 에이전트는 _사용자_ 입력, 감독을 따르며 제품 수준의 액세스 제어를 준수합니다. 기본 CX Enterprise 애플리케이션에서 사용하도록 승인된 작업이나 데이터에만 액세스할 수 있습니다.

### 기존 CX Enterprise 앱의 AI 에이전트 {#existing-apps-table}

다음 표에는 기존 CX Enterprise 애플리케이션에서 사용할 수 있는 Experience Platform 에이전트가 나열되어 있습니다.
