...
| **브랜드 거버넌스 에이전트*** | <ul><li>실시간 거버넌스로 DRM을 지원하기 위해 자동화된 브랜드 정책 확인, 권한, 인텔리전스를 통한 브랜드 무결성 및 규정 준수를 [브랜드 거버넌스](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview):Safeguard합니다.</li></li></ul> | |
