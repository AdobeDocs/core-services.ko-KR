...
별표 (*): 고객은 Explorer 프로그램에 등록하여 이러한 에이전트에 대한 액세스 잠금을 해제할 수 있습니다. Explorer 프로그램은 고객을 선택할 수 있는 혁신적인 최신 에이전트 기능에 대한 조기 액세스를 제공하는 초대 전용 프로그램입니다. 자세한 내용은 계정 담당자에게 문의하십시오.
