...
# Adobe Experience Cloud의 Agentic AI

업데이트됨: **2026년 3월 13일**

Adobe Experience Platform 에이전트는 [Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/ko/docs/experience-cloud-ai/experience-cloud-ai/home)에 의해 구동되어 Experience Cloud 응용 프로그램 내에서 에이전트 AI 기능을 활성화합니다.

이들 상담사는 작업을 자동화하고, 인사이트를 보다 빠르게 제공하고, 워크플로우를 간소화해 줍니다. 따라서 팀은 보다 효율적으로 작업하고 Experience Cloud에서 더 많은 가치를 얻을 수 있습니다.

Experience Cloud의 AI 상담사는 다음 중 하나에서 액세스할 수 있습니다.

* [기존 Experience Cloud 응용 프로그램](#existing-apps)
* [AI 우선 Experience Cloud 애플리케이션](#ai-first-apps)

다음 섹션에서는 Experience Cloud에서 agentic AI를 활성화하는 두 가지 방법에 대해 설명합니다.

## 기존 Experience Cloud 응용 프로그램 {#existing-apps}

기존 애플리케이션에서는 자연어를 사용하여 [AI 도우미](https://experienceleague.adobe.com/ko/docs/experience-cloud-ai/experience-cloud-ai/home) 대화 인터페이스를 통해 Adobe Experience Platform 상담사에게 지시할 수 있습니다. AI 어시스턴트는 전체 화면과 오른쪽 레일 보기에서 모두 사용할 수 있습니다.
...
| [브랜드 거버넌스 에이전트](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview) | <ul><li>실시간 거버넌스로 DRM을 지원하기 위해 자동화된 브랜드 정책 확인, 권한 및 인텔리전스를 통해 브랜드 무결성 및 규정 준수를 보호합니다.</li> | <ul><li>Adobe Experience Manager Assets</li><li>Adobe Experience Manager Sites(브랜드 정책)</li></ul> |
| [Journey Agent](https://experienceleague.adobe.com/ko/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | 팀이 규모에 맞게 멀티 터치 고객 여정을 신속하게 만들고, 분석하고, 최적화할 수 있도록 합니다. | <ul><li>Adobe Journey Optimizer (B2B 및 B2C 에디션)</li></ul> |
...
| 에이전트 이름 | 기능 | 지원되는 애플리케이션 |
| --- | ---------- | ---------- |
| [Experimentation Agent](https://experienceleague.adobe.com/ko/docs/experimentation-accelerator/using/get-started/experiment-accelerator-security) | 인사이트를 자동화, 분석 및 합성하므로 수작업 프로세스를 줄이면서 중앙 집중식 작업 공간에서 영향력이 큰 실험 및 성장 기회를 신속하게 식별할 수 있습니다. | <ul><li>AJO Experimentation Accelerator</li></ul> |
...
[!BADGE Adobe for Business에 대해 자세히 알아보기]{type=Informative url="https://business.adobe.com/kr/products/experience-platform/agent-orchestrator.html" tooltip="Business.adobe.com 로 이동합니다."}
