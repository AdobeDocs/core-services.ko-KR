...
| [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) | 데이터에 대한 질문에 신속하게 답변할 수 있습니다. 데이터 보기의 구성 요소와 실제 데이터를 사용하여 Analysis Workspace에서 관련 시각화를 빌드합니다. | <ul><li>Customer Journey Analytics (B2B 및 B2C 에디션)</li></ul> | 예 |
