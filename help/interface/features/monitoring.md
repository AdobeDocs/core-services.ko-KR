...
관리자는 이 대시보드를 사용하여 권한 부여에 대한 라이선스 소비를 추적합니다. 대시보드에 액세스하려면 [!DNL Experience Platform] 설명서의 [라이선스 사용 대시보드](https://experienceleague.adobe.com/ko/docs/experience-platform/dashboards/guides/license-usage)를 참조하십시오.
