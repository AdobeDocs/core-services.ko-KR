...
1. Experience Cloud 메뉴(![환경 설정](assets/menu-icon.png))를 선택한 다음 **[!UICONTROL 관리]**&#x200B;를 선택합니다.
...
1. 랜딩 페이지에서 선택기 아이콘 ![메뉴](assets/menu-icon.png)를 선택하여 풀다운 메뉴에 액세스합니다.
...
알림으로 이동하려면 **[!UICONTROL 알림]** 아이콘(![알림](assets/notifications-icon.png))을 선택한 다음 **[!UICONTROL 설정]** 아이콘(![편집](assets/icon_edit_board.png))을 선택합니다.
