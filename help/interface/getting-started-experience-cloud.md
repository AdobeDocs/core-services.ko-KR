...
| [Creative Cloud 사용자 관리](t-admin-add-cc-user.md) | Experience Cloud Assets을 통해 마케터는 Creative Cloud를 사용하여 디자이너 및 다른 크리에이티브 자산과 폴더를 공유, 동기화 및 공동 작업할 수 있습니다. 여기서 조직과 공동 작업하도록 승인된 Creative Cloud 사용자를 관리할 수 있습니다. |
