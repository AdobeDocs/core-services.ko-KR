...
1. 자산 폴더에서 **[!UICONTROL Creative Cloud에 공유]**&#x200B;를 클릭합니다.

   ![Creative Cloud에 공유](../../assets/asset-share-cc.png)
1. Creative Cloud으로 공유 페이지에서 사용자를 검색한 다음 **[!UICONTROL 추가]**&#x200B;를 클릭합니다.

   ![Creative Cloud 사용자 추가](../../assets/asset-share-cc-page.png)

1. **[!UICONTROL 공유]**&#x200B;를 클릭합니다.
1. [!DNL Creative Cloud] 데스크톱을 시작하고(또는 브라우저의 [!UICONTROL Creative Cloud 파일] 페이지로 이동) 요청 알림을 찾습니다.

   ![요청 알림](../../assets/cc_share_request.png)
1. 요청을 열고 **[!UICONTROL 승인]**&#x200B;을 클릭합니다.

   ![요청 수락](../../assets/cc_share_accept.png)
1. 폴더 콘텐츠에 액세스하려면 **[!UICONTROL 폴더 열기]**(또는 **[!UICONTROL 웹에서 보기]**)를 클릭하세요.

   ![웹에서 보기](../../assets/creative_cloud_open_folder.png)
1. 공유 에셋에 주석을 추가하여 계속합니다.

   Creative Cloud에서 이미지를 선택한 다음 **[!UICONTROL 활동]**&#x200B;을 클릭하여 이미지에 주석을 추가할 수 있습니다. 주석은 [!DNL Creative Cloud] 및 [!DNL CX Enterprise]의 에셋에서 동기화됩니다.
