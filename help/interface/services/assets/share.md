...
공유 에셋을 사용하는 다른 방법에는 에서 에셋을 로드하거나 교체하는 것이 포함됩니다. [오퍼 라이브러리](https://experienceleague.adobe.com/docs/target/using/experiences/offers/manage-content.html) Adobe Target의 이미지를 참조하십시오.
