...
최근에 [Experience Platform 태그](https://experienceleague.adobe.com/en/docs/experience-platform/tags/home)를 사용하여 Experience Cloud을 구현한 경우 [고객 특성](../services/overview.md) 및 Experience Cloud [대상](../services/audiences/overview.md)에 대해 이미 설정되어 있습니다. [Admin Console](../administration/admin-console.md)에서 사용자와 제품을 관리할 수도 있습니다.
...
[Experience Cloud에서 계정 연결](https://experienceleague.adobe.com/en/docs/core-services/interface/administration/organizations)을 참조하십시오.
...
>[!NOTE]
>
>전체 Experience Cloud ID 서비스 도움말(이전의 방문자 ID)에 대해서는 [Experience Cloud ID 서비스 개요](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html#intro)를 참조하십시오.
...
| 작업 | 설명 |
| --- | --- |
| [Analytics용 Experience Cloud ID 서비스 구현](https://experienceleague.adobe.com/en/docs/analytics/implementation/id/overview) | [고객 ID](https://experienceleague.adobe.com/en/docs/id-service/using/reference/authenticated-state)를 추가적으로 설정하는 것도 좋습니다. 이러한 ID는 각 방문자와 연결되며 Experience Cloud의 현재 및 향후 기능을 활성화합니다. |
