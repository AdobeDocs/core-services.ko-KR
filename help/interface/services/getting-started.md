...
다음을 참조하십시오 [고객 속성](customer-attributes/attributes.md) 자세한 내용을 확인하십시오.
...
다음을 참조하십시오 [대상](audiences/overview.md) 추가 정보.
