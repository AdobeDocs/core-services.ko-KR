...
# CX Enterprise 서비스 {#topic_C1087DCC538F4F9A99D983C1BB29EBE0}

예

이 설명서는 [!DNL People] 서비스([!DNL Audience Library] 및 [!DNL Customer Attributes]), CX Enterprise을 위한 사용자 및 제품 관리, 쿠키, 계정 환경 설정, 알림 등과 같은 CX Enterprise에 있는 통합 헤더의 기능에 적용됩니다.

CX Enterprise에서 이러한 서비스에 액세스하려면 **[!UICONTROL Application Selector]**
...
| [자산](assets/experience-cloud-assets.md) | CX Enterprise Assets은 애플리케이션 간에 공유할 수 있는 마케팅 준비가 끝난 에셋에 대해 중앙 집중식 단일 저장소를 제공합니다. |
