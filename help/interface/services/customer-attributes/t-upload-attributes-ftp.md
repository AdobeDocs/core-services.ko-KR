...
1. **[!UICONTROL Actions]** > **[!UICONTROL File Upload]**&#x200B;을(를) 클릭합니다.
...
[!UICONTROL File Upload and Schema Validation] 페이지에서 **[!UICONTROL FTP Setup]**&#x200B;을(를) 클릭합니다.
...
* 업로드된 **[!UICONTROL attribute:]** 파일에서 `.csv` 특성 데이터를 읽었습니다.

* **[!UICONTROL Type:]** 다음과 같은 데이터 형식:
...
* **[!UICONTROL Display Name:]** 속성의 이름입니다. 예를들어 특성 *customer age*&#x200B;을(를) *customer Since*(으)로 변경할 수 있습니다.

* **[!UICONTROL Description:]** 특성에 대한 설명입니다.
