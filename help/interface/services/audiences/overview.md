...
자세한 내용은 Adobe Analytics 설명서에서 [Experience Cloud에 대한 Publish 세그먼트](https://experienceleague.adobe.com/ko/docs/analytics/components/segmentation/segmentation-workflow/seg-publish)를 참조하십시오.
